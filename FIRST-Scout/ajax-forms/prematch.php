...
*/
                    function sendDataAjax() {
                        ...
                        var sendData = 'prematch_team_present=' + present;
                        sendData += '&prematch_location=' + $("#location").val();
                        sendData += '&prematch_team_number=' + $("#teamNumber").val();
                        sendData += '&prematch_match_number=' + $("#matchNumber").val();
                        sendData += '&prematch_red_alliance=' + redAlliance;

                        xmlHttp.open("POST", "submit-ajax.php", true);
