<!DOCTYPE html>
<!--
 This document will send the following as POST data:
autonomous_top_goals (int)
autonomous_middle_goals (int)
autonomous_bottom_goals (int)
autonomous_missed_goals (int)
autonomous_used_kinect (boolean)
-->
<html>    
    <head>
    ...
    <body>
        <div class="container">
            ...
            <div id="usedKinect" onclick="updateKinect()" style="margin-left: auto; margin-right: auto; margin-top: 5px; margin-bottom: 5px; font-family: Ubuntu, Arial, sans-serif; font-size: 18px">Used Kinect</div>
            ...
            <input type="button" class="centered" id="NextPageButton" onclick="sendData()" value="Continue to Teleoperated &rarr;">
            <br>
            <p id="id" />
        </div>
