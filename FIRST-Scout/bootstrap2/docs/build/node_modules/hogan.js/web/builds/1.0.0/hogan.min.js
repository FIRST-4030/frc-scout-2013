 ...
 */var HoganTemplate = function() {
    ...
    a.prototype = {r: function(a, b) {
            ...
            var f = b[b.length - 1];
            if (a.length > 0)
                return this.ho(a, f, c, this.text.substring(d, e));
            var g = a.call(f);
    ...
    function a(a) {
        ...
        function u(a, b) {
            s();
            if (a && t())
                for (var c = p; c < m.length; c++)
                    m[c].tag || m.splice(c, 1);
            else
                b || m.push({tag: "\n"});
            n = !1, p = m.length
        }
        ...
        for (o = 0; o < f; o++)
            if (j == g)
                ...
                e(r, a, o) ? (o += r.length - 1, m.push({tag: k, n: b(l), i: k == "/" ? n - 1 : o + 1}), l = "", j = g, k == "{" && o++) : l += a[o];
        return u(n, !0), m
    }
    function b(a) {
    ...
    function f(a, b, c, d) {
        ...
        while (a.length > 0) {
            j = a.shift();
            if (j.tag == "#" || j.tag == "^" || g(j, d))
                c.push(j), j.nodes = f(a, j.tag, c, d), e.push(j);
            else {
                if (j.tag == "/") {
                    if (c.length == 0)
                        throw new Error("Closing tag without opener: /" + j.n);
                    i = c.pop();
                    if (j.n != i.n && !h(j.n, i.n, d))
                        throw new Error("Nesting error: " + i.n + " vs. " + j.n);
                    return i.end = j.i, e
                }
                e.push(j)
            }
    ...
    var c = /\S/, d = {"#": 1, "^": 2, "/": 3, "!": 4, ">": 5, "<": 6, "=": 7, _v: 8, "{": 9, "&": 10}, j = /\"/g, k = /\n/g, l = /\r/g, m = /\\/g;
    return{scan: a, parse: function(a, b) {
